    ...
    ILogger<CompositePacketHandler> logger) : IClientPacketHandler, IClientConnectionLifecycle
{
    public Task HandleAsync(ClientConnection connection, PacketFrame packet, CancellationToken cancellationToken)
    {
        return packet.Opcode switch
        {
            ...
            Opcode.CharacterListRequest or Opcode.CharacterCreateRequest or Opcode.CharacterSelectRequest => characterHandler.HandleAsync(connection, packet, cancellationToken),
            ...
            Opcode.PartyChatRequest or Opcode.PartyKickRequest or Opcode.PartyLeaderTransferRequest => socialHandler.HandleAsync(connection, packet, cancellationToken),
